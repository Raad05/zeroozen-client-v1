...
const Footer = () => {
  return (
    <div className="footer-section text-white">
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 py-12">
        <div className="logo w-1/2 mx-auto">
          ...
          <div className="social flex my-2 ml-7">
            <button className="mr-3 hover:scale-125 ease-in-out duration-100 hover:text-cyan-400">
              <a href="/" alt="Twitter">
            ...
            <button className="mr-3 hover:scale-125 ease-in-out duration-100 hover:text-cyan-400">
              <a
                href="https://www.linkedin.com/company/zeroozen/"
                alt="LinkedIn"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <button className="mr-3 hover:scale-125 ease-in-out duration-100 hover:text-cyan-400">
              <a href="/" alt="Twitter">
                <HiLocationMarker size={30}></HiLocationMarker>
              </a>
            </button>
          </div>
        </div>
        <div className="contact w-1/2 mx-auto">
          ...
          <p className="text-xl pb-10">
            <span className="font-bold">Email: </span>contact@zeroozen.com
          </p>
          <p className="text-xl">
            <span className="font-bold">Corporate Office: </span>
            <br></br>33 Shah Ali Tower, Kawran Bazar, Dhaka-1215
          </p>
        </div>
        <div className="newsletter w-1/2 mx-auto">
          ...
          <form className="relative">
            <input
              ...
              className="input w-full max-w-xs bg-white my-5 rounded-md text-black"
            />
            <button
              type="submit"
      ...
      <p className="text-center pb-8 px-5">
        Copyright © 2023 - All right reserved by ZEROOZEN
      </p>
    </div>
  );
};
